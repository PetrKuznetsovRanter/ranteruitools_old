...
namespace RanterTools.UI.Editor
{
    ...
    public class PasswordInputFieldMenu
    {
        ...
        {
            var passwordinputfield = (GameObject)GameObject.Instantiate(Resources.Load("Prefabs/PasswordInputField (TMP)"));
            GameObject parent = null;
            if (Selection.activeObject != null) parent = Selection.activeObject as GameObject;
            if (parent == null) passwordinputfield.transform.parent = null;
            else passwordinputfield.transform.parent = parent.transform;
    ...
    public class PasswordInputFieldEditor : SelectableEditor
    {
        ...
        SerializedProperty m_SwitchButton;
        SerializedProperty m_StarPrefab;
        SerializedProperty m_Stars;
